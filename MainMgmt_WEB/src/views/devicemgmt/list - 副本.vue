...
onMounted(async () => {
    console.log("【Token调试】当前Token值:", authStore.token);  // ← 添加这行
    console.log("【Token调试】请求头:", uploadHeaders.value);    // ← 添加这行
...
// 批量上传
const uploadRef = ref()
const hiddenFileInput = ref(null)  // 隐藏的文件输入框
const uploadKey = ref(0)
// 上传对话框状态
const uploadDialogVisible = ref(false)
const dialogUploadRef = ref(null)  // 对话框内的upload组件
